...
#
# Script ent_decoder.pl converts numeric character reference or character entity reference into 
...
if(@ARGV > 0){
	...
	print "\nUSAGE: ent_decoder < inFile > outFile\n"; 
...
=head1 ent_decoder.pl: converts XML entities into UTF-8
...
C<< perl ent_decoder.pl < inFile > outFile >>
